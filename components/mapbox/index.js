    ...
    <div className='webgl-error'>
      <Notification type='warning'>
        <div>
          ...
          <p>Nous sommes désolés pour le désagrément. N’hésitez pas à <a href='mailto:cadastre@data.gouv.fr'>nous contacter</a> pour plus d’informations.</p>
        </div>
      </Notification>
    </div>
...
class MapWrapper extends React.PureComponent {
  ...
  render() {
    ...
    if (showMap) {
      ...
      return <MapComponent {...properties} />
    }
