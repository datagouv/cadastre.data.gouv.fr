...
const titles = [
  ...
  },
  {
    ...
    description: <span>Données consolidées pour la France entière, produites par Etalab à partir des données de références ci-dessus.<br />5 couches disponibles au format GeoJSON.</span>,
    icon: <FlaskIcon />
  }
]
