...
const titles = [
  ...
  },
  {
    ...
    description: <span>Données consolidées pour la France entière, produites par Etalab à partir des données de référence ci-dessus.<br />6 couches disponibles aux formats GeoJSON et Shapefile.</span>,
    icon: <FlaskIcon />
  }
]
